...
Functions and Closures are exactly the same thing, they just have a different syntax! Therefore, all the 'extras' that Closures pack,
are also available to functions.
