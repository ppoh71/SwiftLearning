...
class PlaySoundsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if  (UserDefaults.standard.object(forKey: "VolumePosition") != nil) {
            print(UserDefaults.standard.float(forKey: "VolumePosition"))
            print("set slider in view")
            sliderView.value = UserDefaults.standard.float(forKey: "VolumePosition")
        }else{
            print("failed in view")
        }
    }
    ...
    @IBAction func sliderDidMove(_ sender: UISlider) {
        ...
        UserDefaults.standard.set(sliderView.value, forKey: "VolumePosition")
