...
class StoryNodeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        print(storyNode.message)
        //print(storyNode.promptCount())
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let storyNode = self.storyNode.storyNodeForIndex(index: (indexPath as IndexPath).row)
        ...
        storyNodeController.storyNode = storyNode
        
        navigationController?.pushViewController(storyNodeController, animated: true)
        print(storyNode)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel!.text = storyNode.promptForIndex(index)
